		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-7">
				<div class="section-title">
					<p class="text-primary text-uppercase fw-bold mb-3">{{ $about->sub_title }}</p>
			...
			<div class="col-lg-4 mt-5 mt-lg-0">
				...
				<img loading="lazy" decoding="async" src="{{ asset($about->image) }}" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
			</div>
		</div>
@else
		...
		<div class="row position-relative">
			...
			<div class="col-xl-3 col-lg-4 col-md-6 mt-4">
				<div class="card bg-transparent border-0 text-center">
                    ...
                    <img loading="lazy" decoding="async" src="{{ asset($item->image) }}" alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
                    @endif



                            @if ($item->fb_url != '' || $item->tw_url != '' || $item->in_url != '' )
                            <ul class="card-social list-inline">
                            @if ($item->fb_url != '')
							<li class="list-inline-item"><a class="facebook" href="{{ $item->fb_url }}"><i class="fab fa-facebook"></i></a>
							</li>
                            @endif
                            @if ($item->tw_url != '')
							<li class="list-inline-item"><a class="twitter" href="{{ $item->tw_url }}"><i class="fab fa-twitter"></i></a>
							</li>
                            @endif
                            @if ($item->in_url != '')
							<li class="list-inline-item"><a class="instagram" href="{{ $item->in_url }}"><i class="fab fa-instagram"></i></a>
							</li>
                            @endif
