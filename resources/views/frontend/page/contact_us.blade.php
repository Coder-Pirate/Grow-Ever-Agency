                            ...
                            <div class="col-lg-6">
                                <div class="contact-form">
                                    ...
                                    <form id="myForm" action="{{ route('submit.contact') }}" method="post"
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="exampleFormControlInput1" class="form-label">Select A
                                                Service</label>

                                            <select name="service_id" class="form-select mb-3" id="service_id"
                                                style="color: #040404" required>
                                ...
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        ...
                                        <div class="content">Call Us We Will Be Happy To Help
                                            <br><a
                                                href="tel:{{ $siteinfo->contact_number }}">{{ $siteinfo->contact_number }}</a>
                                    ...
                                    <div class="block">
                                        <ul class="list-unstyled list-inline my-4 social-icons">
                                            <li class="list-inline-item me-3"><a title="Explorer Facebook Profile"
                                                    class="text-black" href="{{ $siteinfo->fb_url }}"><i
                                                        class="fab fa-facebook-f"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Twitter Profile"
                                                    class="text-black" href="{{ $siteinfo->tw_url }}"><i
                                                        class="fab fa-twitter"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer What's App Profile"
                                                    class="text-black" href="{{ $siteinfo->wh_url }}"><i
                                                        class="fab fa-whatsapp"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Instagram Profile"
                                                    class="text-black" href="{{ $siteinfo->in_url }}"><i
