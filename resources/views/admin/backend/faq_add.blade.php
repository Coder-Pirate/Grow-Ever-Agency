    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('store.faq') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf


                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label"> Question</label>
                        <input type="text" name="qustion" class="form-control" id="qustion" value="">
                    </div>
