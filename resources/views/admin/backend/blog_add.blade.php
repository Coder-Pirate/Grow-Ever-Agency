        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('store.blog') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <img id="showImage" src="{{ (!empty($blogData->image)) ? url('upload/blogimage/'.$blogData->image) : url('upload/no_image.jpg')}}" alt="" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
