    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">Add Poftfolio</h5>

                <form id="myForm" action="{{ route('store.portfolio') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-6">
                        <img id="showImage" src="{{ (!empty($portfolioData->image)) ? url('upload/portfolioimage/'.$portfolioData->image) : url('upload/no_image.jpg')}}" alt="" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
